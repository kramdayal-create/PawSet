...
const navLinks = [
  ...
  { href: "/dashboard/emergency-plan", label: "Emergency Plan", short: "Emergency", icon: AlertTriangle, chip: "bg-paw-limesoft" },
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active
                ? `${link.chip} text-foreground font-semibold shadow-card`
